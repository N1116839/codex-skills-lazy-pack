...
- Also flag the case where an agent creates `暫存.txt` or `下載.txt` and then asks the user what content should go inside. The naming violation has already happened and must be recorded.
